...
TIMES="10"
eval $(wget -qO- "https://raw.githubusercontent.com/znrhdy/vip/main/Fls/botkey")
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              WELCOME TO SRICPT ZNRHDYSTORE              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/znrhdy/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/znrhdy/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/znrhdy/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/znrhdy/vip/main/"
start=$(date +%s)
secs_to_human() {
...
echo ".::. ZNRHDY STORE .::." > /etc/xray/username
echo ""
elif [[ $host == "2" ]]; then
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/znrhdy/izin/main/ip | grep -wE $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/znrhdy/izin/main/ip | grep -wE $ipsaya | awk '{print $3}')
...
wget -q raw.githubusercontent.com/znrhdy/vip/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/znrhdy/vip/main/Enc/encrypt" ; chmod +x /usr/bin/enc
unzip menu.zip
chmod +x menu/*
enc menu/*
...
wget https://raw.githubusercontent.com/znrhdy/vip/main/Cfg/m-noobz 
